...
if __name__ == "__main__":
    if DEBUG:
        filename = f'../large_image_test/LTEST-{i:04d}'
        ext = '.jpg' if i in [6,7,8, 13,11] else '.png'
    ...
    print("=====Starting MPS_NP Skeletonization=====")
    ...
    if not args.negative:
        save_pathproc = f'output-images/{img_name}-TR{args.threshold}-SKL-MPS-NP.png'
    else:
        save_pathproc = f'output-images/{img_name}-TR{args.threshold}-SKL-neg-MPS-NP.png' 
