...
def rule_01(obj_list: list[str], i, h, neigh, active):
...
def rule_02(obj_list: list[str], i, h, neigh, active):
    y = "s0"
    temp_list = []
    if y in obj_list:
...
def rule_03(obj_list: list[str], i, h, neigh, active):
    y = "s1"
    if y in obj_list:
...
def rule_05(obj_list: list[str], i, h, neigh, active):
    y = "h"
    h_holder = ""
    h_ind = 0
...
def rule_06(obj_list: list[str], i, h, neigh, active):
    y = "s11"
    if y in obj_list:
...
def rule_08(obj_list: list[str], i, h, neigh, active):
    y = "s12"
    h_holder = ""
    h_ind = 0
    temp_list = []
...
def rule_09(obj_list: list[str], i, h, neigh, active):
    y = "s13"
    h_ind = 0
    val = 0
    for i in obj_list:
...
def rule_10(obj_list: list[str], i, h, neigh, active):
    y = "s13"
    if y in obj_list:
...
def rule_11(obj_list: list[str], i, h, neigh, active):
    y = "s14"
    tride = 0
    temp_list = []
    for x in range(9):
...
def rule_13(obj_list: list[str], i, h, neigh, active):
    y = "s14"
    if y in obj_list:
        return list(map(lambda x: "s12" if x == y else x, obj_list))
    else:
...
def rule_14(obj_list: list[str], i, h, neigh, active):
    y = "s34"
    if y in obj_list:
        return list(map(lambda x: "s12" if x == y else x, obj_list))
    else:
